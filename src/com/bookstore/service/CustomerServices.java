...
public class CustomerServices {
	...
	public void createCustomer() throws ServletException, IOException {
		...
		if (existCustomer != null) {
			message = "Could not create new customer: the email " + email + " is already registered by another customer.";
		} else {
	...
	public void deleteCustomer() throws ServletException, IOException {
		...
		String message = "The customer has been removed successfully.";
		listCustomers(message);
	}
	...
	public void viewCustomerDetailForAdmin() throws ServletException, IOException {
		...
		String detailPage = "customer_detail.jsp";
